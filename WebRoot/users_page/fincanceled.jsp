		...
		<div class="row">
			...
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-user"></i> 撤销报销单
					</h2>
							...
							<s:iterator value="#session.temp_list" var="fin">
								<tr class="list">
									...
									<td><a class="btn btn-info"
										href='<%=path%>/users/Finance_canceledDetail.action?
										type=Fincanceled&fid=<s:property value="#fin.fid"/>'>
