...
<!-- jQuery -->
<script src="<%=path%>/<%=path%>/bower_components/jquery/jquery.min.js"></script>
...
<!--	location.href="<%=path%>/users/Finance_viewFinancing.action"; 
		location.href="www.baidu.com";
-->
<script>
	function what(){
		var toWhere="<%=session.getAttribute("toWhere")%>";
		if(toWhere!="null"){
			if(toWhere=="toFinancing"){
				location.href="<%=path%>/users/Finance_viewFinancing.action";
			}
			else if(toWhere=="toFinsuccess"){
				location.href="<%=path%>/users/Finance_viewFinsuccess.action";
			}
			<%session.setAttribute("toWhere","null");%>
		}
			...
			<div class="box-inner">
				...
				<form class="form-inline" role="form">
					<table>
						...
						<tr>
							<td></td>
							<td><a class="btn btn-success" onclick="what()"> <i
									class="glyphicon glyphicon-zoom-in icon-white"></i>返回
							</a> <br> <br> <br></td>
						</tr>
