		...
		<div class="row">
			...
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-user"></i> 撤销报销单修改
					</h2>
				...
				<form class="form-inline" role="form" method="post" enctype="multipart/form-data"
					action='<%=path%>/users/Finance_canceledRefin.action?fid=<s:property value="#session.temp_fin.fid"/>'>
					<table>
						<tr>
							...
							<img
								...
								src='<%=picPath%>/<s:property value="#session.temp_fin.imgPath"/>' />
								
								<br /> <br /> <span class="btn btn-default btn-file btn-info">
									更改图片 <input name="file" id="file" type="file">
							</span>
								</td>
