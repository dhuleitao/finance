...
<script>
	function toPay() {
		window.open('<%=path%>/admins/pay.jsp', '_blank');
	//	var r = confirm("是否完成付款");
	}
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i> 待处理
								</h2>
										...
										<s:iterator value="#session.temp_list" var="fin">
											<tr>
												...
												<td class="center"><a class="btn btn-info"
													href="<%=path%>/admins/Finance_detail.action?type=Financing&fid=<s:property value="#fin.fid"/>">
