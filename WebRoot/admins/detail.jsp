	...
	<div class="navbar navbar-default" role="navigation">
		<div class="navbar-inner">
			...
			<a class="navbar-brand" href="index.jsp"> <img
				alt="Charisma Logo" src="<%=path%>/img/logo20.png" class="hidden-xs" />
				<span>DHU</span></a>
				...
				<div class="sidebar-nav">
					<div class="nav-canvas">
						...
						<ul class="nav nav-pills nav-stacked main-menu">
							...
							<li><a class="ajax-link" href="<%=path%>/admins/index.jsp"><i
							...
							<li><a class="ajax-link"
								href="<%=path%>/admins/FinanceAdmin_vFining.action"><i
									class="glyphicon glyphicon-edit"></i><span> 待处理<span
										class="badge">${sessionScope.list_size}</span></span></a></li>
							<li><a class="ajax-link"
							...
							<li><a class="ajax-link"
								href="<%=path%>/admins/changepass.jsp"><i
				...
				<div class="row">
					...
					<div class="box-inner">
						<div class="box-header well" data-original-title="">
							<h2>
								<i class="glyphicon glyphicon-user"></i> 报销单详情
							</h2>
						...
						<form class="form-inline" role="form">
							<table>
								<tr>
									...
									<td><img class="img-responsive"	style="height:280px;width:500px;border:3px  double #545565;"
										src="<%=picPath%>/<s:property value="#session.temp_fin.imgPath"/>" /></td>
								</tr>
								<tr>
									<td></td>
									<td><a class="btn btn-info" target="blank"
										href='<%=path%>/admins/FinanceAdmin_toPay.action?fid=<s:property value="#session.temp_fin.fid"/>'>
											<i class="glyphicon glyphicon-edit icon-white"></i> 报销
									</a> <a class="btn btn-danger"
										href='<%=path%>/admins/FinanceAdmin_Finfail2.action?fid=<s:property value="#session.temp_fin.fid"/>'>
