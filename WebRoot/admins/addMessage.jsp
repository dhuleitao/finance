...
<script>
	function firm() { //利用对话框返回的值 （true 或者 false）
		confirm("添加成功！");//如果是true ，那么就把页面转向thcjp.cnblogs.com
    ...
    <div class="box col-md-12">
       <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-user"></i> 问题添加</h2>
...
<br>
              ...
              <form class="form-inline" role="form"
						action="<%=path%>/admins/Admins_addMes.action" method="post">
						 <br />
						<div class="form-group has-success has-feedback">
							<label class="control-label" for="inputSuccess4">标题:</label> <input
								type="text" name="command" class="form-control" id="inputSuccess4" onfocus="borderColor(this);" onblur="clearTimeout(oTime);"
								>
						</div>
						<br /> <br />
						<div class="form-group has-success has-feedback">
							<label class="control-label" for="inputSuccess4">摘要:</label> <input
								type="text" name="description" class="form-control" id="inputSuccess4" onfocus="borderColor(this);" onblur="clearTimeout(oTime);"
								>
						</div>
						<br /> <br />
							<div class="form-group has-success has-feedback">
							<label class="control-label" for="inputSuccess4">内容:</label> 
								<textarea id="inputSuccess4"  name="content" onfocus="borderColor(this);" onblur="clearTimeout(oTime);" class="form-control" name="content" rows="6" cols="30" onpropertychange="if(this.scrollHeight>80) this.style.posHeight=this.scrollHeight+5" placeholder="请输入内容"></textarea>
						</div>
						<br /> <br />
