...
<div class="ch-container">
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="<%=path%>/admins/FinanceAdmin_vFinfail.action"><i class="glyphicon glyphicon-warning-sign"></i><span> 报销失败 </span></a>
                         ...
                         <li><a class="ajax-link" href="<%=path%>/admins/Admins_changePassword.action"><i class="glyphicon glyphicon-lock"></i><span> 修改密码 </span></a>
                        </li>
  ...
  <div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 报销失败</h2>
  ...
  <form class="form-inline" role="form"
						action="<%=path%>/admins/FinanceAdmin_Finfail.action" method="post">
   <div class="form-group has-success has-feedback">
							<label class="control-label" >驳回原因:</label> <input
						...
						<button class="btn btn-success" type="submit"
							...
							<i class="glyphicon glyphicon-zoom-in icon-white"></i> 提交
						</button>
					</form>
    </div>
    </div>
