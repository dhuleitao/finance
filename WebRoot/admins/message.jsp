...
<link rel="shortcut icon" href="img/favicon.ico">
	<Script Language="JavaScript">
						...
						$("#mainForm").attr("action",path+"/admins/Admins_debatch.action");
						$("#mainForm").submit();
						}
						</Script>
</head>
	...
	<div class="navbar navbar-default" role="navigation">
		...
		<div class="navbar-inner">
			...
			<a class="navbar-brand" href="index.jsp"> <img
				alt="Charisma Logo" src="img/logo20.png" class="hidden-xs" /> <span>DHU</span></a>
					...
					<div class="nav-canvas">
						...
						<ul class="nav nav-pills nav-stacked main-menu">
							...
							<li><a class="ajax-link"
								href="<%=path%>/admins/Admins_toInfo.action"><i
									class="glyphicon glyphicon-eye-open"></i><span> 个人信息</span></a></li>
							<li><a class="ajax-link"
								href="<%=path%>/admins/FinanceAdmin_vFining.action"><i
									class="glyphicon glyphicon-edit"></i><span> 待处理<span class="badge">${sessionScope.list_size}</span></span></a></li>
							<li><a class="ajax-link"
								href="<%=path%>/admins/FinanceAdmin_vFinsuccess.action"><i
									class="glyphicon glyphicon-check"></i><span> 已处理</span></a></li>
							<li><a class="ajax-link"
								href="<%=path%>/admins/FinanceAdmin_vFinfail.action"><i
									class="glyphicon glyphicon-warning-sign"></i><span> 报销失败
								</span></a></li>
							<li><a class="ajax-link"
								href="<%=path%>/admins/Admins_changePassword.action"><i
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i> 常见问题          &nbsp;&nbsp; &nbsp;&nbsp;<i class="glyphicon glyphicon-plus" ></i><a href="addMessage.jsp"> 新增</a>
							...
							<div class="box-content">
								...
								<table
									...
									<tr  <c:if test="${status.index % 2 != 0}">style='background-color:#ECF6EE;'</c:if>>
										...
										<td>
											<a class="btn btn-info glyphicon glyphicon-edit icon-white"href="<%=path%>/admins/Admins_updatemess.action?id=${message.id}">修改</a>&nbsp;&nbsp;&nbsp;
											<a class="btn btn-danger glyphicon glyphicon-trash icon-white"href="<%=path%>/admins/Admins_deone.action?id=${message.id}">删除</a>
										</td>
									</tr>
								</c:forEach>
										...
										<s:iterator value="#session.temp_list" var="fin">
											<tr>
												...
												<td class="center"><a class="btn btn-info"
													href="<%=path%>/admins/FinanceAdmin_Fin.action?fid=<s:property value="#fin.fid"/>"
													onclick="javascript:alert('是否确认报销?')"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 报销
												</a> <a class="btn btn-danger"
													href="<%=path%>/admins/FinanceAdmin_Finfail2.action?fid=<s:property value="#fin.fid"/>">
														<i class="glyphicon glyphicon-trash icon-white"></i> 驳回
												</a></td>
											</tr>
										</s:iterator>
										 -->
